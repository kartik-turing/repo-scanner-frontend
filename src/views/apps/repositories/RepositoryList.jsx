...
import AddCustomerDrawer from './AddRepoDrawer'
...
const RepositoryList = ({ initialData, loading, onDataUpdated }) => {
  // States
  ...
  const deleteItem = async itemId => {
    ...
    try {
      setDeleting(true)
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `api/repositories/${itemId}`, {
        method: 'DELETE',
        headers: {
