...
import AddCustomerDrawer from './AddDiscoveryCodeDrawer'
import AddDbDumpDrawer from './AddDiscoveryCodeDrawer'
import AddDiscoveryCodeDrawer from './AddDiscoveryCodeDrawer'
...
const DiscoveryCodeList = ({ initialData, loading, onDataUpdated }) => {
  // States
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('lineContent', {
        header: 'Line Content',
        cell: info => <Typography>{info.getValue()}</Typography>
      }),
      columnHelper.accessor('lineContentType', {
  ...
  const deleteItem = async itemId => {
    ...
    try {
      setDeleting(true)
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `api/discovery-list-code/${itemId}`, {
        method: 'DELETE',
        headers: {
...
export default DiscoveryCodeList
