...
// Component Imports
import AddCustomerDrawer from './AddSubscriptionDrawer'
...
import AddUniverseDrawer from './AddSubscriptionDrawer'
import { selectLoader } from '@/utils/Helpers'
import './../../apps/logistics/dashboard/styles.css'
import AddDevkitDrawer from './AddSubscriptionDrawer'
...
const SubscriptionList = ({ initialData, loading, onDataUpdated }) => {
  // States
  ...
  const deleteItem = async itemId => {
    ...
    try {
      setDeleting(true)
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `api/subscriptions/${itemId}`, {
        method: 'DELETE',
        headers: {
