...
import AddDiscoveryDBDrawer from './AddDiscoveryDBDrawer'
...
const DiscoveryDBList = ({ initialData, loading, onDataUpdated }) => {
  // States
  ...
  const deleteItem = async itemId => {
    ...
    try {
      setDeleting(true)
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `api/discovery-list-database/${itemId}`, {
        method: 'DELETE',
        headers: {
...
export default DiscoveryDBList
